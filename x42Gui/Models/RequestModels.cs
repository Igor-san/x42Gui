...
namespace x42Gui.Models
{
    ...
    {
        public OutpointRequest() { }

        public OutpointRequest(string txId, int index) => (TransactionId, Index) = (txId, index);
    ...
    public class RecipientModel
    {
      ...
      //  [MoneyFormat(ErrorMessage = "The amount is not in the correct format.")]
        ...
        public  RecipientModel(string to, string how) => (DestinationAddress, Amount) = (to, how);
    }
